...
if not os.path.exists('results_girnet_tfidf'):
		os.makedirs('results_girnet_tfidf')
...
model.load_weights(os.path.join('checkpoints_girnet_tfidf', FLAGS.girnet_model_weights_save))
input_x=[]
input_y=[]
...
print_evaluation_metrics(y_true, y_pred, 'GIRNet', os.path.join('results_girnet_tfidf', FLAGS.log_file))
